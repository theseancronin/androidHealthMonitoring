...
public class ActivityCardRecyclerDate extends RecyclerView.Adapter<ActivityCardRecyclerDate.CardHolder> {

    private ArrayList<ActivityStats> mActivities;
    private Context mContext;

    public ActivityCardRecyclerDate(ArrayList<ActivityStats> activities, Context context) {
    ...
    public CardHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_card_date, parent, false);
    ...
    public void onBindViewHolder(CardHolder holder, int position) {
        ...
        calendar.setTimeInMillis(activity.getDateTime());
        ...
        setTextView(holder.mDate, dateFormat.format(activity.getDateTime()), getActivityColor(activity.getActivityName()));
        setTextView(holder.mTime, timeFormat.format(activity.getDateTime()), getActivityColor(activity.getActivityName()));
